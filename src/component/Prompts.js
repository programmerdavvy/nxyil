...
function Prompts() {
  ...
  const searchPrompts = (e) => {
    ...
    for (let i = 0; i < prompts.length; i++) {
      if (
        prompts[i].topic.toLowerCase().includes(search) ||
        prompts[i].topic.toUpperCase().includes(search)
      ) {
      ...
      <div className='promptsHeaderContainer'>
        <div className='breadcru d-flex align-items-center'>
          ...
          <Link
            ...
            style={{ color: '#5D57D9' }}
          >
            <span className=' fs-5 '>Prompts</span>
          </Link>
        </div>

        <div className='pt-3'>
          <p className='fw-600 promptsHeaderBigText'>All Prompts</p>
          <p className='text-light-emphasis promptsHeadersmallText'>
            Explore all the prompt packs, in one place.
          </p>
        </div>
      </div>
        ...
        <div className='d-flex w-100'>
          <div className=' col-sm-3-l filterSide'>
            <div className='px-3 nav-scroll pt-5'>
              ...
              <div
                className='mt-5 d-none fw-600 fs-6  d-flex justify-content-between'
                style={{
                  borderRadius: '10px',
                  padding: '12px',
                  background: '#EAECF0',
              ...
              {savedPromptCount !== '0' && (
                ...
                >
                  ...
                  >
                    Saved Prompts{' '}
                    <span
                      style={{ background: '#f2f4f7', padding: '12px' }}
                      className='rounded-circle mx-3 p-1 '
                    >
                      {' '}
                      {savedPromptCount}
                    </span>
                    ...
                    return (
                      <div className='px-3 pb-2' key={e.category}>
                        <Input
                          ...
                          onClick={() =>
                            handleAddPack(e.category, `checkbox-${e.category}`)
                          }
                          name={e.category}
                          id={`checkbox-${e.category}`}
            ...
            <div className='searchHeader'>
              <div className='search-header'>
                <Row className='w-100 align-items-center'>
                  ...
                  <Col xl={4} md={6} xs={6} className='' id='searchwfsm'>
                    <div>
                      <div
                        style={{ fontSize: '13px' }}
                        className='loginleftside text-light-emphasis'
                      >
                        Showing 0 of{' '}
                ...
                <div className='d-flex'>
                  {packs?.map((e, i) => {
                    return (
                      <div
                        className='p-2 mt-2 mx-1 bg-white px-3 fw-600 proptslength'
                        key={i}
                        style={{
                          border: '1px solid #d0d5dd',
                          cursor: 'pointer',
              ...
              <Row className=''>
                <PromptCard
                  ...
                  prompts={
                    filteredPrompts.length > 1 ? filteredPrompts : prompts
                  }
                />
              </Row>
            </div>
      ...
      >
        ...
        <ModalBody className='px-sm-5 mx-50 pb-5'>
          ...
          <div className='nav-scroll pt-2'>
            ...
            <div className='mb-2'>
              <Button
                className='w-100  text-dark mt-3 fs-6'
                style={{
                  padding: '12px',
                  background: 'white',
                  border: '1px solid #eee',
